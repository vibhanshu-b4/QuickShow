...
const AddShows = () => {
    ...
    // FIXED: Proper function syntax and logical operators
    const handleDateTimeAdd = () => {
        ...
        setDateTimeInput(""); // Optionally clear input after adding
    };
   ...
   const handleRemoveTime = (date, time) => {
    setDateTimeSelection((prev) => {
        ...
        // Otherwise, update the date with the filtered times
        return {
            ...prev,
            [date]: filteredTimes,
        };
...
const handleAddShow = async () => {
    ...
    if (Object.keys(dateTimeSelection).length === 0) return toast('Please add at least one show time')
                        ...
                        <div
                            ...
                            <div className='relative rounded-lg overflow-hidden'>
                                ...
                                <div className='text-sm flex items-center justify-between p-2 bg-black/70 w-full absolute bottom-0 left-0'>
                                    ...
                                    <p className='text-gray-200'> {kConverter(movie.vote_count)} Votes</p>
                                </div>
                            </div>
